...
* Relational Databases are collections of data organized into tables where as SQL is the language that allows us to communicate and interact with relational databases

- [ ] Why do tables need a `primary key`?

* Tables have primary keys to idenify each row or record in a unique way.
...
* We need an intermediary table with foreign keys from both tables that have the relationship
